...
#pragma once
#ifndef COMPONENTS_DRV_SD_H_
#define COMPONENTS_DRV_SD_H_

extern void drv_sd_init();
extern bool drv_sd_mounted();
extern void sd_print_space();
extern void drv_sd_unmount();
#endif